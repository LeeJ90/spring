...
//            log.info("=========================");
    ...
    public void uploadFormPost(MultipartFile[] uploadFile, Model model){
        ...
        String uploadFolder = "//Users//ijiseong//IdeaProjects//FileUpload//upload//temp";
...
//            log.info("=========================");
    ...
    public ResponseEntity<byte[]> getFile(String fileName){
        ...
        File file = new File("//Users//ijiseong//IdeaProjects//FileUpload//upload//temp//"+fileName);
    ...
    public ResponseEntity<Resource> downloadFile(@RequestHeader("User-Agent") String userAgent, String fileName){
        ...
        Resource resource = new FileSystemResource("//Users//ijiseong//IdeaProjects//FileUpload//upload//temp//"+fileName);
    ...
    public ResponseEntity<String> deleteFile(String fileName, String type){
        ...
        try {
            ...
            file = new File("//Users//ijiseong//IdeaProjects//FileUpload//upload//temp//"+ URLDecoder.decode(fileName,"UTF-8"));
            file.delete();
